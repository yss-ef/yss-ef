...
- **[Smart Factory](https://github.com/yss-ef/smart-factory)**: AI-powered quality control using YOLOv8, MQTT, and real-time inference.
- **[Decentralized Archive](https://github.com/yss-ef/decentralized-course-archive)**: Immutable Web3 academic storage powered by Solidity and Ethereum.
- **[DEVCTL](https://github.com/yss-ef/devctl)**: CLI orchestration for rapid scaffolding of Spring Boot, Angular, and Docker environments.
- **[AWS-Zabbix](https://github.com/yss-ef/aws-zabbix-monitoring)**: Automated cloud infrastructure monitoring and observability on AWS.
